/*! cornerstone-wado-image-loader - v0.14.2 - 2017-02-27 | (c) 2016 Chris Hafey | https://github.com/chafey/cornerstoneWADOImageLoader */
//
// This is a cornerstone image loader for WADO-URI requests.
//
import cornerstoneJS from './cornerstone';
var cornerstone = cornerstoneJS();
import cornerstoneToolsJS from './cornerstoneTools';
...
(function ($, cornerstone, cornerstoneWADOImageLoader) {
  ...
  function getImageFrame(imageId) {
    var imagePixelModule = cornerstoneTools.metaData.get('imagePixelModule', imageId);
...
(function ($, cornerstoneWADOImageLoader) {
  ...
  var defaultConfig = {
    ...
    webWorkerPath : require('./cornerstoneWADOImageLoaderWebWorker.js'),
    webWorkerTaskPaths: [],
    taskConfiguration: {
      'decodeTask' : {
...
export default function cornerstoneWADOImageLoaderJS() {
